...
gcloud compute instances add-metadata instance-1 --metadata commands='["echo hello"]'
gcloud compute instances add-metadata instance-1 --metadata long-commands='["date; sleep 2; date; echo hello; cat /etc/passwd; sleep 5; date; echo hello; cat /etc/passwd; sleep 5; date; echo hello; cat /etc/passwd"]'
...
gcloud compute instances add-metadata instance-1 --metadata commands='["echo $a $b $p"]'
